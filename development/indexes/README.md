...
never edit the generated JSON by hand. Schema version 4 retains the review's
existing-authority-or-evidence cell for unified evidence navigation while
leaving the review-owned rationale out of generated indexes.
...
reviews, complete immutable intake-claim objects, decisions, exception records,
and evidence references by `scripts/build_graph_index.py`. It also exposes
incomplete migration inventories. It is a navigation projection, not an
authoritative lore source. Edit the owning Markdown records and controlled
