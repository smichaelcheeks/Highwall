...
| --- | --- | --- |
| Policy and schema | Knowledge claims, intake claims, histories, lifecycle, provenance, and completion invariants are authoritative policy. | Complete in foundation case |
| Parser and projection | Maintained metadata is parsed structurally and emitted in a unified navigation-only projection. | Complete in foundation case |
| Prospective validation | New and changed objects enforce identity, history, lifecycle, ownership, provenance, and content-boundary rules. | Complete in foundation case |
...
4. retired and superseded objects remain addressable and no durable ID is
   reused;
5. no semantic relationship was inferred from navigation links, prose, or
   co-occurrence;
6. generated projections contain no unexplained migration inventory;
7. deterministic validation and THREAD traversal checks pass; and
8. an independent read-only audit confirms canon equivalence and the story
   boundary.
...
| --- | --- | --- |
| Schema-v2 foundation | `CASE-2026-08-16-KNOWLEDGE-OBJECT-SCHEMA-V2` | Review complete; publication pending |
