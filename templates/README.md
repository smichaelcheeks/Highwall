...
- [`lore-seed.md`](lore-seed.md) prepares raw lore with ChatGPT or another
  assistant before repository intake; it is not itself an intake record.
...
The lore-seed template is author-facing. The intake-submission template is the
repository-facing wrapper that assigns identifiers and preserves a completed
seed verbatim. Do not ask a drafting assistant to manufacture repository
